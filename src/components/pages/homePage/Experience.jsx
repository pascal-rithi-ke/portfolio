...
const Experience = () => {
  ...
  return (
    <div className="container mr-auto p-4 pb-8">
      <h2 className="text-3xl font-bold text-center mt-8">
        Experiences
      </h2>

      <SlideLeft>
        <div className="transition-all duration-1000 ease-in-out transform p-4 md:p-8 w-full mx-auto mb-4 md:mb-8 flex flex-col-reverse md:flex-row shadow-lg rounded-lg">
      ...
      <SlideRight>
        <div className="transition-all duration-1000 ease-in-out transform p-8 w-full mb-8 flex flex-col md:flex-row shadow-lg rounded-lg">
